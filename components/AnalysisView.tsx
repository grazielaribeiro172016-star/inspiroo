...
import { Zap, CheckSquare, ArrowRight, Loader, Paperclip, Pin, Sparkles, Share2 } from 'lucide-react';
...
const AnalysisView: React.FC<AnalysisViewProps> = ({ result, onReset, onSave }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-16 animate-fade-in pb-32 px-4">
      ...
      {/* 1. THE MANIFESTO (Visual Translation) */}
      <div className="relative max-w-4xl mx-auto">
         ...
         <div className="bg-paper-white text-ink-black p-8 md:p-12 shadow-paper-shadow rotate-[-1deg] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <p className="font-mono text-xs text-zinc-400 mb-4 tracking-[0.2em] uppercase">Arquivo #2983 // Classificação: Visionário</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 items-start relative">
        ...
        <div className="lg:col-span-4 bg-[#fef3c7] text-black p-6 shadow-lg rotate-[-3deg] hover:rotate-0 transition-transform duration-300 relative min-h-[250px] flex flex-col">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-red-500 shadow-sm z-10"></div> {/* Pin Head */}
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-0.5 h-3 bg-zinc-400 z-0"></div> {/* Pin Needle */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                        {result.startup_evolution.business_models.map((model, i) => (
      ...
      <div className="bg-paper-white p-8 md:p-12 rotate-[0.5deg] shadow-2xl relative max-w-4xl mx-auto border-t-8 border-brand-yellow">
            ...
            {NEXT_STEPS_LIST.map((step) => {
                ...
                return (
                    ...
                    >
                        ...
                        <span className={`font-hand text-xl ${isChecked ? 'line-through decoration-2 decoration-red-500 text-zinc-400' : 'text-black'}`}>
                            {step}
                        </span>
                    </button>
                )
         ...
         <div className="flex flex-col sm:flex-row justify-center items-center gap-6 pt-8 border-t-2 border-dashed border-zinc-300">
            ...
            >
             ...
             <button onClick={onReset} className="font-hand text-xl underline decoration-wavy decoration-zinc-400 hover:text-brand-yellow transition-colors">
